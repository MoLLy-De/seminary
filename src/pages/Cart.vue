    ...
    <div class="container mx-auto py-8">
      ...
      <div v-if="cart.length > 0">
              ...
              <div>
                ...
                <div class="mt-2 flex items-center">
                  <button
                    ...
                    class="px-2 py-1 bg-purple-200 rounded hover:bg-purple-300"
                  >
                    -
                  </button>
        ...
        <div class="mt-8">
          ...
          <button
            @click="checkout"
            class="mt-4 px-6 py-3 bg-purple-600 text-white font-semibold rounded-lg hover:bg-purple-700 transition duration-300"
          >
            Оформить заказ
          </button>
        </div>
